 ...
 * Generated at: 2020-02-18 04:05:54 UTC
...
private String htmlspecialchars(String str) {
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String htmlData = request.getParameter("content1") != null ? request.getParameter("content1") : "";
      ...
      out.write("\t\t\t<label for=\"title\">文章标题:</label> <input\r\n");
      out.write("\t\t\t\tclass=\"form-control form-control-sm\" id=\"title\" type=\"text\"\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t所属栏目: \r\n");
      out.write("\t\t\t<select class=\"form-control form-control-sm\" id=\"channel\" name=\"channelId\">\r\n");
      out.write("\t\t\t\t<option value=\"-1\">请选择</option>\r\n");
      out.write("\t\t\t</select> \r\n");
      out.write("\t\t\t所属分类: \r\n");
      out.write("\t\t\t<select class=\"form-control form-control-sm\" id=\"category\" name=\"categoryId\">\r\n");
      out.write("\t\t\t\t<option>请选择</option>\r\n");
      out.write("\t\t\t</select>\r\n");
      out.write("\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t标题图片: <input type=\"file\" name=\"file\"\r\n");
      out.write("\t\t\t\tclass=\"form-control form-control-sm \">\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t<button type=\"button\" class=\"btn btn-success\" onclick=\"publish()\">发布文章</button>\r\n");
      ...
      out.write("\t\t\t//获取formDAta对象\r\n");
      out.write("\t\t\tvar formData = new FormData($(\"#form1\")[0]);\r\n");
      out.write("\t\t\t//单独封装富文本编辑中内容(html格式的)\r\n");
      ...
      out.write("\t\t\t\t\t\tlocation.href=\"/my/index\"\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t//栏目.分类的下拉框的赋值\r\n");
      out.write("\t\t$(function() {\r\n");
      out.write("\t\t\t//先查询出所有栏目\r\n");
      out.write("\t\t\t$.get(\"/channel/channels\", function(list) {\r\n");
      out.write("\t\t\t\tfor ( var i in list) {\r\n");
      out.write("\t\t\t\t\t$(\"#channel\").append(\r\n");
      out.write("\t\t\t\t\t\t\t\"<option value='\"+list[i].id+\"'>\" + list[i].name+ \"</option>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t})\r\n");
      out.write("\t\t\t//为栏目绑定change事件\r\n");
      out.write("\t\t\t$(\"#channel\").change(\r\n");
      out.write("\t\t\t\t\tfunction() {\r\n");
      out.write("\t\t\t\t\t\tvar channelId = $(this).val();\r\n");
      out.write("\t\t\t\t\t\t$(\"#category\").empty();\r\n");
      out.write("\t\t\t\t\t\tif (channelId == -1) {\r\n");
      out.write("\t\t\t\t\t\t\t//先清空栏目已有的值\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#category\").html(\"<option>请选择</option>\");\r\n");
      out.write("\t\t\t\t\t\t\t//获取栏目ID.如果为-1 则不查询\r\n");
      out.write("\t\t\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t//获取当前选中的栏目ID\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t// alert(channelId);\r\n");
      out.write("\t\t\t\t\t\t//去查询栏目下的分类并赋值到下拉框\r\n");
      out.write("\t\t\t\t\t\t$.get(\"/category/selects\", {\r\n");
