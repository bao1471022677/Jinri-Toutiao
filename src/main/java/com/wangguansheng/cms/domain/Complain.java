...
public class Complain implements Serializable{
	...
	public int hashCode() {
		...
		result = prime * result + ((complain_num == null) ? 0 : complain_num.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (articleId == null) {
			...
			return false;
		if (complain_num == null) {
			if (other.complain_num != null)
				return false;
		} else if (!complain_num.equals(other.complain_num))
			return false;
		if (content == null) {
