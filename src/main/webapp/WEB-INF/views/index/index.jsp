		...
		<div class="row" style="margin-top: 5px">
						...
						<div id="carouselExampleCaptions" class="carousel slide"
							...
							<div class="carousel-inner" style="height: 300px">
								<div class="carousel-item active">
									<img src="/images/da.jpg" class="d-block w-100" alt="...">
									<div class="carousel-caption d-none d-md-block">
										<p>大圣齐天</p>
									</div>
								</div>
								<div class="carousel-item">
									<img src="/images/mao.png" class="d-block w-100" alt="...">
									<div class="carousel-caption d-none d-md-block">
										<p>o(=•ェ•=)m</p>
									</div>
								</div>
								<div class="carousel-item">
									<img src="/images/ta.png" class="d-block w-100" alt="...">
									<div class="carousel-caption d-none d-md-block">
										<p>她</p>
									</div>
								</div>
	        ...
	        <!-- 图片集 -->
					...
					<div class="card-body">
					 <c:forEach items="${picInfo.list}" var="p">
						<div class="media">
							...
							<div class="media-body">
								<h5 class="mt-0"><a href="/articlepic?id=${p.id }" target="_blank">${p.title}</a></h5>
							</div>
						</div>
							<hr>
	                   </c:forEach>
				...
				<div class="card" style="width: 18rem;">
					...
					<div class="row">
						<div class="card-body">
						<a href="https://www.jd.com/"><img alt="" src="/images/go.jpg" style="height: 100px;padding-left: 5px"></a>
						</div>
						<div class="card-body">
